...
% result
[motionVectorUint8, predictionVectorUint8] = ICV_getMotionVectors(frame1DevidedIntoBlocks, frame2DevidedIntoBlocks, blocksInRow, blocksInColumn, blockHeight, blockWidth, searchWindow);
end